...
opt = {
    ...
    load_net = '/mnt/disk1/kennethm/graphmodels_new/graph_vgonly_VG_multiclass_net_epoch_20.t7',                      -- Classification net to load
    load_vgg_net = '/mnt/disk1/kennethm/graphmodels_new/graph_vgonly_VG_vgg_net_epoch_20.t7',                  -- VGG net to load
    load_gsnn_net = '/mnt/disk1/kennethm/graphmodels_new/graph_vgonly_VG_gsnn_net_epoch_20.t7',                 -- GSNN net to load
    load_opt = '/mnt/disk1/kennethm/graphmodels_new/graph_vgonly_VG_params',                      -- Where to load options used to train the net
...
-- Testing loop
local numtest = math.floor(data:size()-data:trainSize())
for i = 1, numtest, opt.batchSize do
    ...
    for i = 1, opt.batchSize do
        ...
        for j = 1, #active_idx do
            ...
            local output_idx = graph.vocab_reverse_lookup[full_graph_idx]
            assert(full_graph_idx == output_idx)
