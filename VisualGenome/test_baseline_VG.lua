...
opt = {
    ...
    load_net = '/mnt/disk1/kennethm/graphmodels_new/baseline_VG_multiclass_net_epoch_20.t7',                      -- Classification net to load
    load_vgg_net = '/mnt/disk1/kennethm/graphmodels_new/baseline_VG_vgg_net_epoch_20.t7',                  -- VGG net to load
    load_opt = '/mnt/disk1/kennethm/graphmodels_new/baseline_VG_params',                      -- Where to load options used to train the net
...
-- Load graph
local graph = torch.load(opt.dataloc .. '/torchdata/pruned_graph.t7')[1]
...
for i = 1, numtest, opt.batchSize do
    ...
    local imdata, lab, labinds = data:getTestBatch(i)
    data_tm:stop()
    ...
    -- Forward pass
    local output = net:forward(vgg_out)
