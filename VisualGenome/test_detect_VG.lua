...
opt = {
    ...
    load_net = '/mnt/disk1/kennethm/graphmodels_new/detect_VG_multiclass_net_epoch_20.t7',                      -- Classification net to load
    load_vgg_net = '/mnt/disk1/kennethm/graphmodels_new/detect_VG_vgg_net_epoch_20.t7',                  -- VGG net to load
    load_opt = '/mnt/disk1/kennethm/graphmodels_new/detect_VG_params',                      -- Where to load options used to train the net
