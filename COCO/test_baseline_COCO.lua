...
opt = {
    ...
    load_net = '/mnt/disk1/kennethm/graphmodels_coco/baseline_COCO_multiclass_net_epoch_20.t7',                      -- Classification net to load
    load_vgg_net = '/mnt/disk1/kennethm/graphmodels_coco/baseline_COCO_vgg_net_epoch_20.t7',                  -- VGG net to load
    load_opt = '/mnt/disk1/kennethm/graphmodels_coco/baseline_COCO_params',                      -- Where to load options used to train the net
...
for i = 1, numtest, opt.batchSize do
    ...
    -- Forward pass
    local final_output = net:forward(vgg_out)
